(function () {
    ...
    function EditorialContentController(
        ...
        function _deleteRow() {
            ...
            var tempArray = [];
            var rowIndex = vm.dndListCols.map(function (e) { return e.rowId }).indexOf(vm.rowToDelete.rowId);
        ...
        function getSuccess(data) {
            ...
            if (data.items != null) {
                ...
                console.log("tempRowNum: " + JSON.stringify(tempRowNum));
                ...
                vm.notify(function () {
                    ...
                    if (maxRows > 0 || tempRowNum.length > 0) {
                        vm.newRowRef = maxRows + 1
                    } else {
                        vm.newRowRef = 0;
                    }
                    console.log(vm.newRowRef);
