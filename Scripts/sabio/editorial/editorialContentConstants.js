(function () {
    ...
    .constant("editorialContentConfig", {
        "templates": [
            { contentTypeId: "1", name: "Text", pageContent: "Your text content will go here.", icon: "fa-align-right", contentOptions: { border: 'none', fontSize: '18px', rowRef: 0 } },
            { contentTypeId: "3", name: "Divider", icon: "fa-chain-broken", contentOptions: { dividerColor: '#3c454d', dividerStyle: 'solid', href: '#', rowRef: 0 } },
            { contentTypeId: "4", name: "Image", contentData: [{ value: "http://placehold.it/150x150" }], icon: "fa-file-image-o", contentOptions: { imgAlignment: 'centerImg', border: 'none', rowRef: 0, imgWidth: '100%', imgHeight: 'auto', imgMinHeight: '300px', imgPosX: 0, imgPosY: 0 } },
            { contentTypeId: "7", name: "Image + Caption", pageContent: "Your text content will go here.", contentData: [{ value: "http://placehold.it/150x150" }], icon: "fa-newspaper-o", contentOptions: { bgcolor: '#FFFFFF', captionPos: 'bottomCapt', imgAlignment: 'centerImg', border: 'none', rowRef: 0, imgWidth: '100%', imgHeight: 'auto', imgMinHeight: '300', imgPosX: 0, imgPosY: 0 } },
